Scriptname GLT_MageSkillActivator extends GLT_SkillActivator

ObjectReference Property FirePillar Auto

function select()
	FirePillar.SetAnimationVariableFloat("fmagicburnamount", 1)
	goToState("active")
endFunction

function deselect()
	FirePillar.SetAnimationVariableFloat("fmagicburnamount", 0)
	goToState("dormant")
endFunction
