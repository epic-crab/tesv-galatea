Scriptname GLT_ThiefSkillActivator extends GLT_SkillActivator

ObjectReference Property ChestActivator Auto

function select()
	goToState("transitioning")
	ChestActivator.playGamebryoAnimation("Open", true)
	Utility.wait(2.5)
	goToState("active")
endFunction
...
function deselect()
	goToState("transitioning")
	ChestActivator.playGamebryoAnimation("Close", true)
	Utility.wait(2.5)
	goToState("dormant")
endFunction
